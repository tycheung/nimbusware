...
| `nimbusware_console` | Admin display helpers + enterprise fleet formatters; workflow explainers share `explainer_core/` (`metrics_scaffold`, `schema_metrics`, `workflow_exports`); BFF tables via `routes/admin_ui_bff.py` |
