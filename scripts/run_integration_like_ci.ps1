...
# Usage:
#   $env:HERMES_DATABASE_URL = "postgresql://hermes:hermes@127.0.0.1:5432/hermes"
#   $env:HERMES_REPO_ROOT = (Resolve-Path .).Path   # optional; defaults to repo root
#   .\scripts\run_integration_like_ci.ps1

$ErrorActionPreference = "Stop"
$root = Split-Path -Parent $PSScriptRoot
if (-not $env:HERMES_REPO_ROOT) {
    $env:HERMES_REPO_ROOT = $root
}
