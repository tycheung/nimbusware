...
2. Run worker with bounded idle exit:
   - `poetry run python scripts/ops/run_dispatch_worker.py --max-idle-loops 20 --idle-sleep-seconds 0.1`
...
2. Start one or more workers:
   - `poetry run python scripts/ops/run_dispatch_worker.py --max-idle-loops 0`
3. For finite drain windows:
   - `poetry run python scripts/ops/run_dispatch_worker.py --max-idle-loops 200 --idle-sleep-seconds 0.1`
