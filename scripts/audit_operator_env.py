...
ENV_GET = re.compile(
    r'os\.environ\.get\(\s*["\']((?:HERMES|NIMBUSWARE|OLLAMA|PORT)[A-Z0-9_]*)["\']',
)
ENV_SETITEM = re.compile(
    r'os\.environ\[["\']((?:HERMES|NIMBUSWARE|OLLAMA|PORT)[A-Z0-9_]*)["\']\]\s*=',
)
SETENV = re.compile(
    r'(?:monkeypatch\.)?setenv\(\s*["\']((?:HERMES|NIMBUSWARE|OLLAMA|PORT)[A-Z0-9_]*)["\']',
)
...
BOOTSTRAP_REL = frozenset(
    {
        ...
        "nimbusware_env/admin_token.py",
        "hermes_orchestrator/preflight_cli.py",
        "hermes_orchestrator/run_dispatch.py",
        "hermes_orchestrator/fleet_worker.py",
        "hermes_orchestrator/replay_cli.py",
        "hermes_orchestrator/routing_suggestions_cli.py",
        "hermes_orchestrator/telemetry_cli.py",
        "hermes_orchestrator/scraper_object_store.py",
        "hermes_orchestrator/ollama_manage.py",
        "hermes_orchestrator/llm/common.py",
        "hermes_memory/cli.py",
        "hermes_memory/sync_cli.py",
        "hermes_memory/embeddings.py",
        "hermes_extensions/bundle_memory_factory.py",
        ...
        "hermes_orchestrator/runtime_bootstrap.py",
        ...
        "hermes_memory/factory.py",
        "hermes_memory/contribution.py",
        "hermes_memory/event_scan.py",
        "hermes_memory/remote_store.py",
        "hermes_memory/repo_scope.py",
        "hermes_research/enterprise_index.py",
