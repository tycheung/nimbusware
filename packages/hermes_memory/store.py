        ...
        with self._connect() as conn:
            ...
            with conn.cursor() as cur:
                ...
                cur.execute(
                    ...
                    DELETE FROM hermes_memory_chunk
                ...
                cur.execute(
                    ...
                    DELETE FROM hermes_memory_index_generation
                ...
                cur.execute(
                    ...
                    INSERT INTO hermes_memory_index_generation (
                ...
                for ch in chunks:
                    ...
                    cur.execute(
                        ...
                        INSERT INTO hermes_memory_chunk (
        ...
        with self._connect() as conn:
            ...
            with conn.cursor(row_factory=dict_row) as cur:
                ...
                cur.execute(
                    ...
                    FROM hermes_memory_index_generation
...
def _chunk_from_row(rec: dict[str, Any]) -> MemoryChunkRecord:
    ...
    return MemoryChunkRecord(
        ...
        source_store_seq=int(rec["source_store_seq"]) if rec.get("source_store_seq") is not None else None,
