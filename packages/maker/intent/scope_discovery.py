...
from maker.archetype_surface_defaults import apply_fleet_surface_policy
from maker.archetype_workflow import FULLSTACK_CAMPAIGN_PROFILES
...
def scope_discover(
    ...
    *,
    ...
    from maker.discovery_required_fields import questions_for_required_fields
...
def _manifest_from_answers(
    ...
    *,
    ...
    from maker.archetype_surface_defaults import _apply_regulated_stack_guard
...
def discovery_complete_for_start(
    ...
    *,
    ...
    from maker.discovery_required_fields import (
...
def scope_confirm(state: dict[str, Any], *, tenant_slug: str | None = None) -> dict[str, Any]:
    from maker.stack_manifest import freeze_manifest, validate_frozen_manifest
...
def attach_discovery_summary(state: dict[str, Any]) -> dict[str, Any]:
    from maker.stack_manifest import discovery_summary_from_answers
