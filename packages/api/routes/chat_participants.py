...
from api.deps import ChatStoreDep, CollabStoreDep
...
def resolve_join_discipline(
    *,
    ...
    for candidate in (body_discipline, invite_discipline):
        ...
        if normalized:
            return normalized
    from maker.tenant_collab_defaults import tenant_default_join_discipline
...
def tenant_slug_for_session(session: Any) -> str | None:
    ...
    try:
        ...
        from iam.store import build_iam_store
...
def preview_chat_join(
    ...
    try:
        ...
        pass
    from maker.tenant_collab_defaults import tenant_default_agent_overlay
...
def join_chat_session(
    ...
    from maker.tenant_collab_defaults import seed_tenant_agent_overlay_on_join
