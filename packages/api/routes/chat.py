...
from api.deps import ChatStoreDep, CollabStoreDep, ProjectStoreDep, StoreDep
from api.errors import problem
from api.routes import chat_session
...
def get_chat_session(
    ...
    *,
    ...
    if nimbusware_collab_enabled():
        ...
        from maker.user_participant_context import load_user_participant_context
