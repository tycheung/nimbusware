...
from api.schemas.openapi import PROBLEM_RESPONSE_422, PROBLEM_RESPONSE_500
...
from orchestrator.run_dispatch import get_run_queue, run_dispatch_enabled
...
async def lifespan(app: FastAPI) -> AsyncIterator[None]:
    ...
    try:
        from config.collab_settings_store import load_persisted_collab_enabled
        from env import find_repo_root
        from env.collab_runtime import set_runtime_collab_enabled
    ...
    if url:
        try:
            from env.settings_resolve import refresh_scope_caches
            from env.settings_store import apply_all_managed_to_environ
...
from api.routes.admin_web import mount_admin_web  # noqa: E402
from api.routes.maker_web import mount_maker_web  # noqa: E402
from api.routes.ui_shared_web import mount_ui_shared  # noqa: E402
...
def _build_openapi_schema() -> dict[str, Any]:
    ...
    from api.openapi_access import enrich_openapi_access_tags
