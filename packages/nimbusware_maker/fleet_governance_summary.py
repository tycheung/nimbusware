...
def fleet_governance_summary(
    *,
    ...
    from nimbusware_orchestrator.fleet_policies import tenant_enforcement_policy
...
def _deploy_approval_chain(tenant_slug: str | None, bundle: str) -> str:
    if bundle != "enterprise":
        return "maker_only"
    from nimbusware_orchestrator.fleet_policies import tenant_deploy_approval_policy
