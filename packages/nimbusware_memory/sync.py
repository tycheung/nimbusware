...
from nimbusware_memory.manifest import default_memory_index_dir, read_manifest
...
def memory_sync_manifest_stub(repo_root: Path) -> dict[str, Any]:
    ...
    from nimbusware_memory.org_scope import fleet_memory_enabled
    ...
    if fleet_memory_enabled():
        try:
            from nimbusware_memory.remote_store import resolve_canonical_store_root
