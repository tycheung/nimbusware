...
from nimbusware_memory.chunking import chunks_from_event_rows
from nimbusware_memory.embeddings import embedding_model_id_for_mode
...
from nimbusware_memory.indexer import RebuildIndexResult, _drafts_to_records
from nimbusware_memory.manifest import MemoryIndexManifest, write_manifest
from nimbusware_memory.models import EmbeddingMode
from nimbusware_memory.org_scope import resolve_fleet_scope
...
def rebuild_fleet_memory_index(
    ...
    *,
    ...
    if audit_store is not None and audit_run_id is not None:
        from nimbusware_memory.audit import append_memory_indexed_event
