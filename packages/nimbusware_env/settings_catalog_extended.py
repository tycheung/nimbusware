...
def extended_defs() -> tuple[SettingDef, ...]:
    uc_keys: tuple[tuple[str, str], ...] = (
        ...
        (
            ...
            "Planner stage failed on gate fail",
        ),
        (
            "NIMBUSWARE_PLANNER_CRITIQUE_EMIT_FINDING_ON_GATE_FAIL",
            "Planner emit finding on gate fail",
        ),
    ...
    user_extra = (
        ...
        SettingDef(
            ...
            "Max characters for repo map excerpt before packet cap.",
            "User — maker runtime",
        ),
        SettingDef(
        ...
        SettingDef(
            ...
            "Max characters for symbol sketch metadata.",
            "User — maker runtime",
        ),
        SettingDef(
            ...
            "Max characters for secondary LLM stages and tool message history.",
        ...
        SettingDef(
            ...
            "Max characters for cross-slice handoff block in prompts.",
            "User — context efficiency",
        ),
        SettingDef(
