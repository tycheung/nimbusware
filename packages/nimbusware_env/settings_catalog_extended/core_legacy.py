...
def core_legacy_runtime_defs() -> tuple[SettingDef, ...]:
    ...
    return (
        ...
        SettingDef(
            "NIMBUSWARE_COMPUTE_WORK_QUEUE",
            install,
            e,
            "",
            "Compute work-unit queue",
            "memory, redis, or postgres for mesh work-unit persistence.",
            "Install — infrastructure",
        ...
        SettingDef(
            "NIMBUSWARE_MESH_WORKSPACE_FALLBACK",
            install,
            e,
            "",
            "Mesh workspace fallback",
            "When on, workers without workspace in payload use NIMBUSWARE_WORKSPACE or repo root.",
            "Install — infrastructure",
            choices=("", "0", "1"),
            admin_editable=False,
            user_editable=False,
