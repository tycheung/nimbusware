...
API_BASE = os.environ.get("NIMBUSWARE_API_BASE", "http://127.0.0.1:8000/v1")
...
st.caption(streamlit_theme_defaults_caption(repo_root=Path(os.environ.get("NIMBUSWARE_REPO_ROOT", "."))))
