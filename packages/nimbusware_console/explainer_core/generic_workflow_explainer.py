...
def _agent_evaluator_caption_parts(metrics: Mapping[str, Any]) -> list[str]:
    parts: list[str] = []
...
def _escalation_suppress_caption_parts(metrics: Mapping[str, Any]) -> list[str]:
    parts: list[str] = []
...
def _universal_critique_caption_parts(metrics: Mapping[str, Any]) -> list[str]:
...
def _security_scan_metadata_caption_parts(metrics: Mapping[str, Any]) -> list[str]:
    parts: list[str] = []
...
def _self_refinement_caption_parts(metrics: Mapping[str, Any]) -> list[str]:
    parts: list[str] = []
...
_YAML_EXPLAINERS: dict[str, CaptionPartsFn] = {
    "agent_evaluator": _agent_evaluator_caption_parts,
    "escalation_suppress": _escalation_suppress_caption_parts,
    "universal_critique": _universal_critique_caption_parts,
    "security_scan_metadata": _security_scan_metadata_caption_parts,
    "self_refinement": _self_refinement_caption_parts,
}
