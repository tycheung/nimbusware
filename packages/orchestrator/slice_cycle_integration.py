...
from orchestrator.slice_cycle_emits import (
    emit_diagnose_learn,
    emit_repo_explore,
    emit_resolution_council,
)
from orchestrator.slice_cycle_improvement import (
...
def ensure_dev_environment_for_slice(
    ...
    from orchestrator.dev_env_milestones import dev_env_auto_start_enabled
...
def run_pre_gate_dev_env_regression(
    ...
    from orchestrator.dev_env_milestones import dev_env_http_regression_enabled
    ...
    ui_passed: bool | None = None
    ui_detail = ""
    from orchestrator.dev_env_milestones import dev_env_ui_regression_enabled
