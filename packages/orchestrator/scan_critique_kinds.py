...
from orchestrator.scan_critique_llm import execute_scan_critique_llm
from orchestrator.scan_critique_tools import scan_tools_failed
from orchestrator.scan_stub_critique_emit import (
    ScanStubCritiqueConfig,
    emit_scan_stub_critique_panel,
)
from orchestrator.workflow_scan_critique import scan_critique_gate_timeline_summary
...
def run_security_scan_summary(workspace: Path) -> dict[str, Any]:
    from orchestrator.security_scan import run_security_scan, security_scan_tool_summary
    from orchestrator.sql_profiler import run_sql_profiler_summary
