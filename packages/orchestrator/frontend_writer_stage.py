...
<html lang="en">
<head><meta charset="utf-8"><title>Nimbusware</title></head>
<body><main><h1>Nimbusware frontend scaffold</h1></main></body>
</html>
"""
...
def run_frontend_writer_stage(workspace: Path) -> tuple[int, str, Literal["validate", "scaffold"]]:
    ...
    if not target.is_file():
        target.write_text(_MINIMAL_INDEX, encoding="utf-8")
