...
def _scan_store_as_tenant(
    ...
    from iam.context import get_auth_context, reset_auth_context, set_auth_context
...
def tenant_run_metrics(
    ...
    *,
    ...
    from orchestrator.fleet.ollama_sli import fleet_ollama_sli_status_snapshot
