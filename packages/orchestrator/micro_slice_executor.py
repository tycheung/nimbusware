...
from orchestrator.llm_slice import execute_slice_replan_llm
from orchestrator.micro_slice import SlicePlan, micro_slice_count_for_run
from orchestrator.micro_slice_plan import (
...
from orchestrator.micro_slice_run_context import (
...
from orchestrator.micro_slice_executor_gate import finish_micro_slice_gate_chain
    ...
    *,
    ...
    while True:
        ...
        if isinstance(ms_eff, dict) and ms_eff.get("fleet_cap_active"):
            from orchestrator.fleet_slice_caps import fleet_replan_metadata
