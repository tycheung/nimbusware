...
from orchestrator.slice.implement import execute_slice_implement
from orchestrator.slice.micro_slice import SlicePlan, micro_slice_count_for_run
from orchestrator.slice.plan import (
...
from orchestrator.slice.run_context import (
    micro_slice_effective_from_rows,
    slice_replan_max_for_run,
)
from orchestrator.slice.verify import (
...
from orchestrator.slice.executor_context import (
    _emit_slice_stage,
    _resolve_slice_block,
    resolve_slice_block_for_plan,
)
from orchestrator.slice.executor_gate import finish_micro_slice_gate_chain
    ...
    *,
    ...
    while True:
        ...
        if isinstance(ms_eff, dict) and ms_eff.get("fleet_cap_active"):
            from orchestrator.fleet.slice_caps import fleet_replan_metadata
