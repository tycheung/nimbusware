...
from orchestrator.slice.diff import check_slice_diff_budget, collect_slice_diff_stats
...
from orchestrator.slice.run_context import fast_slice_effective_from_rows
