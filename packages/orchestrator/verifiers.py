...
from orchestrator.workspace_layout import WorkspaceLayout, detect_workspace_layout
...
def run_mypy_on_layout(
    ...
    *,
    ...
    from env.env_flags import nimbusware_run_mypy_enabled
...
def run_bandit(workspace: Path, *, timeout_seconds: float = 120.0) -> tuple[int, str]:
    from env.env_flags import nimbusware_run_bandit_enabled
