...
from orchestrator.backlog_heuristic import generate_heuristic_backlog
...
def validate_backlog(
    ...
    *,
    ...
    from orchestrator.backlog_manifest import validate_manifest_backlog
        ...
        if nimbusware_use_llm_enabled():
            ...
            if model.strip():
                ...
                if repo_root is not None:
                    try:
                        from orchestrator.slice_repo_map import build_repo_map_excerpt
