...
from orchestrator.llm.providers import provider_for_preset
from orchestrator.stage_provider_routing import resolve_stage_provider
...
def _load_defaults_yaml(repo_root: Path) -> dict[str, Any]:
    from config.model_routing_sections import load_model_bindings_defaults_doc
    ...
    def resolve(
        ...
        *,
        ...
        if user_defaults is None:
            from config.model_bindings_store import load_user_defaults
    ...
    def chat_json(
        ...
        **resolve_kwargs: Any,
        ...
        if not binding.model_id:
            ...
            raise ValueError(msg)
        if api_key is None:
            from orchestrator.model_routing.credentials import resolve_binding_api_key
