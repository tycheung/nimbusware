...
from orchestrator.micro_slice_run_context import micro_slice_effective_from_rows
...
def _launch_test_enabled(rows: list[dict[str, Any]]) -> bool:
    from orchestrator.dev_env_policy import launch_test_enabled
...
def resolve_slice_block_for_plan(
    ...
    from orchestrator.slice_interjection import _project_from_run_rows
