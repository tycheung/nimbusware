...
from orchestrator.put_e2e_capture import (
...
from orchestrator.put_e2e_factory_flows import (
    factory_flows_root,
...
from orchestrator.put_e2e_http_steps import _run_http_step
from orchestrator.put_e2e_types import PutE2EFinding, PutE2EResult, PutE2EVerdict
...
def run_put_e2e_flow(
    ...
    *,
    ...
    def _attach_browser_capture(
        ...
        *,
        ...
        if not _should_attach_browser():
            return capture
        from orchestrator.put_e2e_browser import capture_failure_browser_trace
        from orchestrator.put_e2e_evidence import put_e2e_evidence_dir
    ...
    if workspace is not None and workspace.is_dir() and _should_attach_browser():
        from orchestrator.put_e2e_evidence import write_put_e2e_evidence
