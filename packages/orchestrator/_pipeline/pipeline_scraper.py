...
from env.env_flags import nimbusware_outbound_fetch_enabled
...
from orchestrator._pipeline.protocol_hosts import PipelineScraperHost
            ...
            self._store.append(
                StageFailedEvent(
                    ...
                    payload=StageFailedPayload(
                        ...
                        message="NIMBUSWARE_OUTBOUND_FETCH_ENABLED not set",
                    ),
                ),
            )
            return
