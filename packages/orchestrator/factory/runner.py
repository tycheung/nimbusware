...
from orchestrator.factory.capture import (
...
from orchestrator.factory.factory_flows import (
    factory_flows_root,
...
from orchestrator.factory.http_steps import _run_http_step
from orchestrator.factory.types import PutE2EFinding, PutE2EResult, PutE2EVerdict
...
def run_put_e2e_flow(
    ...
    *,
    ...
    def _attach_browser_capture(
        ...
        *,
        ...
        if not _should_attach_browser():
            return capture
        from orchestrator.factory.browser import capture_failure_browser_trace
        from orchestrator.factory.e2e_evidence import put_e2e_evidence_dir
    ...
    from orchestrator.fleet.playwright import (
    ...
    if workspace is not None and workspace.is_dir() and _should_attach_browser():
        from orchestrator.factory.e2e_evidence import write_put_e2e_evidence
