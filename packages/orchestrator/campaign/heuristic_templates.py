...
KEYWORD_TEMPLATES: tuple[tuple[tuple[str, ...], str], ...] = (
    (("crm", "customer", "contact", "birthday", "sales"), "crm"),
...
HEURISTIC_TEMPLATES: dict[str, HeuristicTemplate] = {
    ...
    "fullstack_crm": HeuristicTemplate(
        template_id="fullstack_crm",
        feature_title="Full-stack birthday CRM",
        acceptance=(
            "REST API stores contacts with name, email, and birthday",
            "Web UI can add/edit contacts",
            "Birthday email sender can be triggered (SMTP stub ok)",
            "Contract between API and UI is stable",
        ),
        slices=(
            HeuristicSliceSpec(
                "slice-api-001",
                "API scaffold",
                "Backend scaffold with health check and project layout",
                ("backend/", "app.py", "main.py", "pyproject.toml"),
                90,
                surface_id="api",
                stack_id="fastapi_python",
            ...
            HeuristicSliceSpec(
                "slice-api-002",
                "Contacts + birthdays API",
                "Contact model and CRUD with birthday field",
                ("backend/", "contact", "routes", "api"),
                120,
                surface_id="api",
                stack_id="fastapi_python",
            ),
            HeuristicSliceSpec(
                ...
                "Triggerable birthday email job (console/log SMTP stub ok)",
                ("backend/", "email", "birthday", "jobs"),
                100,
                surface_id="api",
                stack_id="fastapi_python",
            ),
            HeuristicSliceSpec(
                "slice-api-004",
                "API tests",
                "Backend tests for contacts and birthday sender",
                ("backend/tests", "test_"),
                80,
                surface_id="api",
                stack_id="fastapi_python",
            ...
            HeuristicSliceSpec(
                "slice-web-002",
                "Contacts UI",
                "Add/edit contacts with birthday fields in the web UI",
