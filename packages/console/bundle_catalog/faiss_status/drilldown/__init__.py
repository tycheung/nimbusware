from console.bundle_catalog.faiss_status.drilldown.captions import (
...
from console.bundle_catalog.faiss_status.drilldown.dir_captions import (
...
from console.bundle_catalog.faiss_status.drilldown.tables import (
