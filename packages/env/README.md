...
| `env_flags.py` | Catalog-backed env reads (`nimbusware_database_url`, `nimbusware_repo_root_path`, `nimbusware_clone_url`, `nimbusware_sandbox_backend`, `nimbusware_tenant_id`, `nimbusware_bundle_memory_rank_weight`, tri-state flags, URL helpers) |
