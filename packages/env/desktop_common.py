...
from env.env_flags import nimbusware_clone_url

NIMBUSWARE_SCHEMA_REL = Path("packages/store/schema/postgres.sql")
...
def default_install_script_args() -> list[str]:
    from env.launcher_fetch import install_script_args
