...
from env.linux_desktop_deps import ensure_linux_desktop_deps, linux_desktop_manual_hint
from maker.quick_mode import apply_quick_mode_env
...
def start_servers(
    *,
    ...
    _spawn([*py_cmd, "-m", "api.cli"], cwd=root, env=env)
