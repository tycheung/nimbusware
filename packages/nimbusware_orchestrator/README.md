...
- **`binding_preflight.py`** — provider-aware readiness (`roles_covered`, `providers_reachable`); optional `stack_manifest` adds `surface_stage_map` for full-stack campaigns.
