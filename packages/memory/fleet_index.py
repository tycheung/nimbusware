...
from memory.chunking import chunks_from_event_rows
from memory.embeddings import embedding_model_id_for_mode
from memory.event_scan import fetch_event_rows_for_memory_index
from memory.faiss_index import build_memory_faiss_index
from memory.indexer import RebuildIndexResult, _drafts_to_records
from memory.manifest import MemoryIndexManifest, write_manifest
from memory.models import EmbeddingMode
from memory.org_scope import resolve_fleet_scope
from memory.repo_scope import repo_scope_hash, resolve_repo_root
...
def rebuild_fleet_memory_index(
    ...
    *,
    ...
    if audit_store is not None and audit_run_id is not None:
        from memory.audit import append_memory_indexed_event
