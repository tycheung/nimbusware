...
from memory.index.embeddings import embed_text
from memory.index.faiss_index import faiss_search_chunk_ids, try_load_memory_faiss
from memory.index.manifest import default_memory_index_dir, latest_generation_id
from memory.index.models import EmbeddingMode, MemoryChunkRecord, MemoryRetrievalHit
from memory.index.repo_scope import repo_scope_hash, resolve_repo_root
from memory.index.user_scope import user_memory_index_dir, user_scope_hash
