...
| Chat | `chat.js` + `chat_shell_html.js`, `chat_collab_wiring.js`, `chat_*_ui.js` | `/chat/sessions` (create, list, graph, fork, active-leaf), classify/start, inline theater SSE digest (`THEATER_CAP=12`; full theater on Progress) |
...
| Settings | `settings.js` + `settings_governor_ui.js`, `settings_*_ui.js` | `/settings/me`, hardware profile, **Run launch check** |
