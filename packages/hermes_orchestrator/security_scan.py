...
def run_security_scan(
    ...
    """Run security + optional Phase 3 perf/N+1 scanners.

    Returns ``(worst_exit, merged_log, ruff, bandit, mypy, ruff_perf, n_plus_one)``.
  Skipped tools count as success (exit 0).
    ...
    worst = max(ruff_code, bandit_code, mypy_code, perf_code, n1_code)
    log = (
    ...
    return worst, log, ruff_code, bandit_code, mypy_code, perf_code, n1_code
