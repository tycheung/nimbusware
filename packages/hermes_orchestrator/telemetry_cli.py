...
from hermes_orchestrator.role_telemetry import aggregate_recent_run_telemetry


def _build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        description="Aggregate Hermes per-role token/latency hints from recent runs.",
    )
