...
class RedisRunQueue:
    ...
    def __init__(
        ...
        redis_url: str,
        *,
        queue_key: str = "hermes:run_dispatch:queue",
        in_flight_key: str = "hermes:run_dispatch:in_flight",
        ...
        try:
            ...
            msg = "redis package is required for HERMES_RUN_DISPATCH=redis"
...
def run_dispatch_mode() -> str | None:
    ...
    raw = os.environ.get("HERMES_RUN_DISPATCH", "").strip().lower()
    if not raw:
        return None
