...
from hermes_orchestrator.persona_shelf_promotion import try_auto_shelve_probation_persona
from hermes_orchestrator.workflow_probation_automation import ProbationAutomationWorkflowBlock
...
def _probation_auto_shelve_env_disabled() -> bool:
    return env_falsy("HERMES_PROBATION_AUTO_SHELVE")


def _probation_notify_env_disabled() -> bool:
    return env_falsy("HERMES_PROBATION_NOTIFY_BEFORE_PROMOTE")
