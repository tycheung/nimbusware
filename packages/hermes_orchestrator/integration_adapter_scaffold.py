...
_ADAPTER_MODULE_TEMPLATE = '''"""Hermes-generated integration adapter ({kind}).
...
Generated by Hermes Integration Adapter Writer.
"""
...
def write_integration_adapter_scaffold(
    ...
    rel_dir = Path(".hermes") / "integration_adapter_writer" / str(run_id)
