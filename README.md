...
- **Bundle integrator** — catalog search, FAISS ranking, compatibility scoring, integrator gate; optional GitHub Checks or GitLab commit status bridge ([docs/deploy/external-ci-bridge.md](docs/deploy/external-ci-bridge.md))
