...
Layout and CI subsets: [`tests/README.md`](tests/README.md). Pytest collects **~3,500** items repo-wide; the default PR **unit** job runs **~2,650** tests at **≥75%** coverage (81% total line coverage as of Jun 2026). Playwright: **42** tests across **29** specs in [`tests/e2e/web`](tests/e2e/web).
