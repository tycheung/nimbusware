...
- Tabbed web UI: Home, Build, Review, Progress (SSE theater + maker-progress), Plan, Models, Settings; PWA manifest + offline service worker (`sw.js`); `?run_id=` deep links
