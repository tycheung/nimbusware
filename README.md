...
Layout and CI subsets: [`tests/README.md`](tests/README.md). Pytest collects **3,560+** items repo-wide; the default PR **unit** job runs **~2,786** tests at **≥75%** coverage (82% total line coverage as of Jun 2026). Playwright: **53** tests across **39** specs in [`tests/e2e/web`](tests/e2e/web).
...
Full catalog: `poetry run python scripts/audit_operator_env.py` (231 keys).
