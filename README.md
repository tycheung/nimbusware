...
Layout and CI subsets: [`tests/README.md`](tests/README.md). Pytest collects **3,560+** items repo-wide; the default PR **unit** job runs **~2,760** tests at **≥75%** coverage (82% total line coverage as of Jun 2026). Playwright: **49** tests across **36** specs in [`tests/e2e/web`](tests/e2e/web).
