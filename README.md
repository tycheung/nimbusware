...
Layout and CI subsets: [`tests/README.md`](tests/README.md). Pytest collects **3,686** items repo-wide; the default PR **unit** job runs **~2,803** tests at **≥75%** coverage (82% total line coverage as of Jun 2026). Playwright: **55** tests across **41** specs in [`tests/e2e/web`](tests/e2e/web) (120s per-spec timeout under parallel load).
