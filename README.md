...
See [CONTRIBUTING.md](CONTRIBUTING.md) for import boundaries, linting, and typing tranches. Default CI runs **~3011** unit tests (plus 81 Playwright specs); full pytest collection is **~3868** tests.
