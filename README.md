...
Layout and CI subsets: [`tests/README.md`](tests/README.md). Pytest collects **3,560+** items repo-wide; the default PR **unit** job runs **~2,700** tests at **≥75%** coverage (81% total line coverage as of Jun 2026). Playwright: **44** tests across **31** specs in [`tests/e2e/web`](tests/e2e/web).
