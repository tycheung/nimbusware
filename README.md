...
Layout and CI subsets: [`tests/README.md`](tests/README.md). Pytest collects **3,557** items repo-wide; the default PR **unit** job runs **~2,696** tests at **≥75%** coverage (81% total line coverage as of Jun 2026). Playwright: **43** tests across **30** specs in [`tests/e2e/web`](tests/e2e/web).
