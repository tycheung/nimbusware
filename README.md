...
- **Operator ribbons** — dev-env start/stop/regression, interjection Next/Last queue, autopilot slider (`GET/PUT /v1/runs/{id}/autopilot`), improvement/resolution council summary from timeline (including `feature_gap_matrix.gaps` when present)
