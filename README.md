...
Layout and CI subsets: [`tests/README.md`](tests/README.md). Pytest collects **3,560+** items repo-wide; the default PR **unit** job runs **~2,791** tests at **≥75%** coverage (82% total line coverage as of Jun 2026). Playwright: **54** tests across **40** specs in [`tests/e2e/web`](tests/e2e/web).
