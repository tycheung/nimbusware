...
def test_tranche_d_paths_in_ci_targets() -> None:
    ...
    assert "packages/api/routes/runs/list_helpers.py" in text
    assert "packages/console" in text
    assert "packages/maker" in text
