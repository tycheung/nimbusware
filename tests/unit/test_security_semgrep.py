...
from orchestrator.critique.security_semgrep import run_semgrep_scan, semgrep_enabled
...
@patch("orchestrator.critique.security_semgrep.shutil.which", return_value=None)
