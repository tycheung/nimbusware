...
from orchestrator.model_routing.resolver import ResolvedBinding
...
def test_resolve_binding_api_key_from_env_ref() -> None:
    ...
    with patch(
        "orchestrator.model_routing.credentials.env_str",
...
def test_resolve_binding_api_key_from_vault() -> None:
    ...
    with patch(
        ...
        with patch(
            "orchestrator.model_routing.credentials.nimbusware_database_url",
