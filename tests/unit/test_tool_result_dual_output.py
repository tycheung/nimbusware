...
from agent_tools.shell_tools import ToolResult, _result, tool_read_file, tool_run_shell
...
def test_shell_strips_ansi_for_llm() -> None:
    ...
    proc.backend = "none"
    with (
        patch("agent_tools.sandbox_bridge.run_subprocess_in_sandbox", return_value=proc),
        patch(
