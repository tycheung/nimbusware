...
def test_explainer_escalation_policy_yaml_absent(tmp_path: Path) -> None:
    ...
    assert pl["escalation_policy_yaml_top_level_kinds"] == {
        "mapping": 0,
        "scalar": 0,
        "list": 0,
        "other": 0,
...
def test_escalation_policy_yaml_deadlock_minutes_caption() -> None:
    cap = escalation_policy_yaml_deadlock_minutes_caption(
        {
            "escalation_policy_yaml_path_exists": True,
            "escalation_policy_yaml_deadlock_escalation_after_minutes": 12,
        },
    )
    assert cap is not None
    assert "12" in cap
    assert "minutes" in cap
    cap1 = escalation_policy_yaml_deadlock_minutes_caption(
        {
            "escalation_policy_yaml_path_exists": True,
...
def test_escalation_policy_yaml_anti_deadlock_min_progress_caption() -> None:
    ...
    cap = escalation_policy_yaml_anti_deadlock_min_progress_caption(
        {
            "escalation_policy_yaml_path_exists": True,
            "escalation_policy_yaml_load_error": None,
            "escalation_policy_yaml_anti_deadlock_min_progress_events": 9,
        },
    )
    assert cap == "Escalation policy anti_deadlock.min_progress_events: **9** events."
    cap_one = escalation_policy_yaml_anti_deadlock_min_progress_caption(
        {
            "escalation_policy_yaml_path_exists": True,
            "escalation_policy_yaml_anti_deadlock_min_progress_events": 1,
        },
    )
    ...
    assert (
        escalation_policy_yaml_anti_deadlock_min_progress_caption(
            {
                "escalation_policy_yaml_path_exists": True,
                "escalation_policy_yaml_anti_deadlock_min_progress_events": True,
            },
        )
        is None
    )
...
def test_escalation_policy_yaml_anti_deadlock_shape_caption_true() -> None:
    cap = escalation_policy_yaml_anti_deadlock_shape_caption(
        {
            "escalation_policy_yaml_path_exists": True,
            "escalation_policy_yaml_load_error": None,
            "escalation_policy_yaml_has_anti_deadlock_mapping": True,
        },
    )
    assert cap is not None
    ...
    cap = escalation_policy_yaml_anti_deadlock_shape_caption(
        {
            "escalation_policy_yaml_path_exists": True,
            "escalation_policy_yaml_load_error": None,
            "escalation_policy_yaml_has_anti_deadlock_mapping": False,
        },
    )
    assert cap is not None
        ...
        escalation_policy_yaml_anti_deadlock_shape_caption(
            {
                "escalation_policy_yaml_path_exists": True,
                "escalation_policy_yaml_load_error": None,
                "escalation_policy_yaml_has_anti_deadlock_mapping": None,
            },
        )
        is None
    )
...
def test_escalation_policy_yaml_top_level_kinds_caption_none_for_non_mapping() -> None:
    assert escalation_policy_yaml_top_level_kinds_caption(None) is None
    assert escalation_policy_yaml_top_level_kinds_caption("x") is None
    assert escalation_policy_yaml_top_level_kinds_caption([1, 2, 3]) is None
...
def test_escalation_policy_yaml_top_level_kinds_caption_bare_zero_returns_none() -> None:
    cap = escalation_policy_yaml_top_level_kinds_caption(
        {"mapping": 0, "scalar": 0, "list": 0, "other": 0},
    )
    assert cap is None
...
def test_escalation_policy_yaml_top_level_kinds_caption_treats_non_int_as_zero() -> None:
    cap = escalation_policy_yaml_top_level_kinds_caption(
        {"mapping": "2", "scalar": True, "list": None, "other": 1.5},
    )
    assert cap is None
...
def test_escalation_policy_yaml_mtime_caption_none_for_non_mapping() -> None:
    assert escalation_policy_yaml_mtime_caption(None) is None
    assert escalation_policy_yaml_mtime_caption("x") is None
    assert escalation_policy_yaml_mtime_caption([1, 2]) is None
...
def test_escalation_policy_yaml_mtime_caption_none_when_mtime_iso_missing() -> None:
    payload = {
        "escalation_policy_yaml_path_exists": True,
        "escalation_policy_yaml_load_error": None,
        "escalation_policy_yaml_mtime_iso": None,
        "escalation_policy_yaml_age_seconds": 10,
    }
...
def test_escalation_policy_yaml_mtime_caption_none_when_age_missing_or_bool() -> None:
    base = {
        "escalation_policy_yaml_path_exists": True,
        "escalation_policy_yaml_load_error": None,
        "escalation_policy_yaml_mtime_iso": "2026-01-01T00:00:00Z",
    }
    assert (
        escalation_policy_yaml_mtime_caption({**base, "escalation_policy_yaml_age_seconds": None})
        is None
    )
    assert (
        escalation_policy_yaml_mtime_caption({**base, "escalation_policy_yaml_age_seconds": True})
        is None
    )
    assert (
        escalation_policy_yaml_mtime_caption({**base, "escalation_policy_yaml_age_seconds": "5"})
        is None
    )
...
def test_escalation_yaml_key_present_caption() -> None:
    cap_absent = escalation_yaml_key_present_caption(
        {"escalation_yaml_key_present": False},
    )
    assert cap_absent is not None
    assert "absent" in cap_absent
    cap_on = escalation_yaml_key_present_caption(
        {
            "escalation_yaml_key_present": True,
            "suppress_automatic_escalation_effective": True,
        },
    )
    assert cap_on is not None
    assert "true" in cap_on
    cap_off = escalation_yaml_key_present_caption(
        {
            "escalation_yaml_key_present": True,
...
def test_escalation_suppress_flag_caption_none_for_non_mapping() -> None:
    assert escalation_suppress_flag_caption(None) is None
    assert escalation_suppress_flag_caption("x") is None
    assert escalation_suppress_flag_caption([1, 2]) is None


def test_escalation_suppress_flag_caption_none_on_load_error() -> None:
    payload = {
        "load_error": "boom",
        "suppress_automatic_escalation_effective": True,
        "suppress_automatic_escalation_yaml_raw_type": "bool",
    }
...
def test_escalation_suppress_flag_caption_none_when_effective_non_bool() -> None:
    ...
    assert (
        escalation_suppress_flag_caption(
            {**base, "suppress_automatic_escalation_effective": 1},
        )
        is None
    )
    assert (
        escalation_suppress_flag_caption(
            {**base, "suppress_automatic_escalation_effective": "true"},
        )
        is None
    )
    assert (
        escalation_suppress_flag_caption(
            {**base, "suppress_automatic_escalation_effective": None},
        )
        is None
    )
...
def test_escalation_suppress_flag_caption_composite_false_nonetype() -> None:
    payload = {
        "load_error": None,
        "suppress_automatic_escalation_effective": False,
        "suppress_automatic_escalation_yaml_raw_type": "NoneType",
    }
    assert (
        escalation_suppress_flag_caption(payload)
        == "Suppress automatic escalation: False (YAML raw type: NoneType)."
    )
...
def test_escalation_policy_yaml_verification_shape_caption_true() -> None:
    cap = escalation_policy_yaml_verification_shape_caption(
        {
            "escalation_policy_yaml_path_exists": True,
            "escalation_policy_yaml_load_error": None,
            "escalation_policy_yaml_has_verification_mapping": True,
        },
    )
    assert cap is not None
    ...
    cap = escalation_policy_yaml_verification_shape_caption(
        {
            "escalation_policy_yaml_path_exists": True,
            "escalation_policy_yaml_load_error": None,
            "escalation_policy_yaml_has_verification_mapping": False,
        },
    )
    assert cap is not None
    assert "no top-level" in cap.lower()
        ...
        escalation_policy_yaml_verification_shape_caption(
            {
                "escalation_policy_yaml_path_exists": True,
                "escalation_policy_yaml_load_error": None,
                "escalation_policy_yaml_has_verification_mapping": None,
            },
        )
        is None
    )
...
def test_escalation_policy_yaml_key_count_caption_none_for_non_mapping() -> None:
    assert escalation_policy_yaml_key_count_caption(None) is None
    assert escalation_policy_yaml_key_count_caption("x") is None
    assert escalation_policy_yaml_key_count_caption([1, 2]) is None


def test_escalation_policy_yaml_key_count_caption_none_on_policy_load_error() -> None:
    payload = {
        "escalation_policy_yaml_load_error": "boom",
        "escalation_policy_yaml_path_exists": True,
        "escalation_policy_yaml_top_level_key_count": 3,
    }
...
def test_escalation_policy_yaml_key_count_caption_none_when_count_non_int() -> None:
    ...
    assert (
        escalation_policy_yaml_key_count_caption(
            {**base, "escalation_policy_yaml_top_level_key_count": "3"},
        )
        is None
    )
    assert (
        escalation_policy_yaml_key_count_caption(
            {**base, "escalation_policy_yaml_top_level_key_count": None},
        )
        is None
    )
...
def test_escalation_policy_yaml_key_count_caption_none_when_count_bool() -> None:
    payload = {
        "escalation_policy_yaml_load_error": None,
        "escalation_policy_yaml_path_exists": True,
        "escalation_policy_yaml_top_level_key_count": True,
    }
    assert escalation_policy_yaml_key_count_caption(payload) is None
...
def test_escalation_policy_yaml_key_count_caption_none_when_count_negative() -> None:
    payload = {
        "escalation_policy_yaml_load_error": None,
        "escalation_policy_yaml_path_exists": True,
        "escalation_policy_yaml_top_level_key_count": -1,
    }
    assert escalation_policy_yaml_key_count_caption(payload) is None
...
def test_escalation_policy_yaml_version_caption_none_for_non_mapping() -> None:
    assert escalation_policy_yaml_version_caption(None) is None
    assert escalation_policy_yaml_version_caption("x") is None


def test_escalation_policy_yaml_version_caption_none_on_policy_load_error() -> None:
    payload = {
        "escalation_policy_yaml_load_error": "boom",
        "escalation_policy_yaml_path_exists": True,
        "escalation_policy_yaml_version": 2,
    }
...
def test_escalation_policy_yaml_version_caption_none_when_version_bool() -> None:
    payload = {
        "escalation_policy_yaml_load_error": None,
        "escalation_policy_yaml_path_exists": True,
        "escalation_policy_yaml_version": True,
    }
    assert escalation_policy_yaml_version_caption(payload) is None


def test_escalation_policy_yaml_max_retries_caption_none_for_non_mapping() -> None:
    assert escalation_policy_yaml_max_retries_caption(None) is None


def test_escalation_policy_yaml_max_retries_caption_none_on_policy_load_error() -> None:
    payload = {
        "escalation_policy_yaml_load_error": "boom",
        "escalation_policy_yaml_path_exists": True,
        "escalation_policy_yaml_max_retries_per_stage": 5,
    }
    assert escalation_policy_yaml_max_retries_caption(payload) is None
...
def test_escalation_policy_yaml_max_retries_caption_emits_for_non_negative() -> None:
    ...
    assert (
        escalation_policy_yaml_max_retries_caption(payload)
        == "Escalation policy max retries per stage: **5**."
    )
    zero = {**payload, "escalation_policy_yaml_max_retries_per_stage": 0}
    assert (
        escalation_policy_yaml_max_retries_caption(zero)
        == "Escalation policy max retries per stage: **0**."
    )


def test_escalation_policy_yaml_keys_sample_caption_none_for_non_mapping() -> None:
    assert escalation_policy_yaml_keys_sample_caption(None) is None
    assert escalation_policy_yaml_keys_sample_caption("x") is None
    assert escalation_policy_yaml_keys_sample_caption([1, 2]) is None


def test_escalation_policy_yaml_keys_sample_caption_none_on_policy_load_error() -> None:
    payload = {
        "escalation_policy_yaml_load_error": "boom",
        "escalation_policy_yaml_path_exists": True,
        "escalation_policy_yaml_top_level_keys_sample": ["a", "b"],
    }
...
def test_escalation_policy_yaml_keys_sample_caption_none_when_sample_not_list() -> None:
    ...
    assert (
        escalation_policy_yaml_keys_sample_caption(
            {**base, "escalation_policy_yaml_top_level_keys_sample": "a"},
        )
        is None
    )
    assert (
        escalation_policy_yaml_keys_sample_caption(
            {**base, "escalation_policy_yaml_top_level_keys_sample": None},
        )
        is None
    )
...
def test_escalation_policy_yaml_keys_sample_caption_none_when_all_unusable() -> None:
    payload = {
        "escalation_policy_yaml_load_error": None,
        "escalation_policy_yaml_path_exists": True,
        "escalation_policy_yaml_top_level_keys_sample": ["   ", "", 1, None, False],
    }
    assert escalation_policy_yaml_keys_sample_caption(payload) is None
...
def test_escalation_policy_yaml_keys_sample_caption_single_entry() -> None:
    payload = {
        "escalation_policy_yaml_load_error": None,
        "escalation_policy_yaml_path_exists": True,
        "escalation_policy_yaml_top_level_keys_sample": ["  foo  "],
    }
    assert (
        escalation_policy_yaml_keys_sample_caption(payload)
        == "Policy YAML top-level keys (sample): foo."
    )
...
def test_escalation_policy_yaml_keys_sample_caption_three_entries_order_preserved() -> None:
    payload = {
        "escalation_policy_yaml_load_error": None,
        "escalation_policy_yaml_path_exists": True,
        "escalation_policy_yaml_top_level_keys_sample": ["z", "a", "m"],
    }
    assert (
        escalation_policy_yaml_keys_sample_caption(payload)
        == "Policy YAML top-level keys (sample): z, a, m."
    )
...
def test_escalation_policy_yaml_keys_sample_caption_mixed_skips_non_strings() -> None:
    payload = {
        "escalation_policy_yaml_load_error": None,
        "escalation_policy_yaml_path_exists": True,
        "escalation_policy_yaml_top_level_keys_sample": ["ok", 99, None, "  bar  "],
    }
    assert (
        escalation_policy_yaml_keys_sample_caption(payload)
        == "Policy YAML top-level keys (sample): ok, bar."
    )
...
def test_escalation_policy_yaml_relpath_caption_none_for_non_mapping() -> None:
    assert escalation_policy_yaml_relpath_caption(None) is None


def test_escalation_policy_yaml_relpath_caption_none_on_load_error() -> None:
    payload = {
        "escalation_policy_yaml_load_error": "boom",
        "escalation_policy_yaml_path_exists": True,
...
def test_escalation_policy_yaml_keys_all_table_rows_at_most_twelve(
    ...
    sample_only = {
        "escalation_policy_yaml_top_level_keys_sample": (
            pl["escalation_policy_yaml_top_level_keys_sample"]
        ),
    }
...
def test_escalation_suppress_explainer_table_rows_export_json_and_csv() -> None:
    payload = {
        "workflow_profile": "wf",
        "suppress_automatic_escalation_effective": True,
        "escalation_policy_yaml_top_level_kinds": {
    ...
    rows = escalation_suppress_explainer_table_rows(payload)
    assert len(rows) == len(payload)
    assert any(r["field"] == "workflow_profile" for r in rows)
    kinds_row = next(r for r in rows if r["field"] == "escalation_policy_yaml_top_level_kinds")
    assert '"mapping": 1' in kinds_row["value"]
    parsed = json.loads(escalation_suppress_explainer_export_json(payload))
    assert parsed["workflow_profile"] == "wf"
    csv_text = escalation_suppress_explainer_table_rows_csv(rows)
    assert csv_text.splitlines()[0] == "field,value"
    assert escalation_suppress_explainer_table_rows({}) == []  # type: ignore[arg-type]
    assert escalation_suppress_explainer_table_rows_csv([]) == ""
    assert escalation_suppress_export_filename_slug() == "escalation_suppress"
...
def test_escalation_suppress_explainer_table_rows_tmp_path(tmp_path: Path) -> None:
    ...
    rows = escalation_suppress_explainer_table_rows(pl)
    assert len(rows) == len(pl)
    assert json.loads(escalation_suppress_explainer_export_json(pl)) == pl


def test_escalation_suppress_workflow_explainer_operator_metrics_policy_file_bytes() -> None:
    m = escalation_suppress_workflow_explainer_operator_metrics(
        {
            "escalation_policy_yaml_path_exists": True,
            "escalation_policy_yaml_file_bytes": 512,
        },
    )
...
def test_escalation_suppress_workflow_explainer_operator_metrics_policy_age() -> None:
    m = escalation_suppress_workflow_explainer_operator_metrics(
        {"escalation_policy_yaml_age_seconds": 42},
    )
    ...
    m = escalation_suppress_workflow_explainer_operator_metrics(
        {
            ...
            "suppress_automatic_escalation_effective": True,
            "escalation_policy_yaml_path_exists": True,
            "escalation_policy_yaml_top_level_key_count": 5,
        },
    )
...
def test_escalation_suppress_workflow_explainer_operator_metrics_export() -> None:
    m = escalation_suppress_workflow_explainer_operator_metrics({})
    rows = escalation_suppress_workflow_explainer_operator_metrics_table_rows(m)
    assert rows[0]["field"] == "Escalation key present"
    assert (
        escalation_suppress_workflow_explainer_operator_metrics_export_filename_slug()
        == "escalation_suppress_workflow_explainer_operator_metrics"
    )
