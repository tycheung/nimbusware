...
from hermes_orchestrator.ollama_chat import extract_ollama_usage
from hermes_orchestrator.registry import RoleRegistry
from hermes_orchestrator.role_telemetry import (
    ROLE_TELEMETRY_METADATA_KEY,
    aggregate_role_telemetry_rows,
    extract_role_telemetry_hint,
    merge_role_telemetry_metadata,
)
from hermes_orchestrator.routing_suggestions import (
