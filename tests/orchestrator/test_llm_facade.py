"""LLM package facade — stable patch targets on ``hermes_orchestrator.llm_plan``."""

from __future__ import annotations

import hermes_orchestrator.llm_plan as llm_plan
...
def test_llm_submodules_exist() -> None:
    from hermes_orchestrator.llm import plan_stage, implementation_critique
