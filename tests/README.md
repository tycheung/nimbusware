...
- Composite contract tests share helpers in `tests/unit/composite_contract_fixtures.py` (dict event builders, gate/finding scans) and `tests/unit/composite_store_fixtures.py` (`InMemoryEventStore` append helpers).
