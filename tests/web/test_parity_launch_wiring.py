...
_WIRING = Path(__file__).resolve().parent / "parity_launch_wiring.yaml"
...
def test_parity_launch_wiring_specs_exist_on_disk() -> None:
...
def test_parity_launch_wiring_ids_are_web_true_in_matrix() -> None:
