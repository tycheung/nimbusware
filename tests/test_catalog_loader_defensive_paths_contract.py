"""Catalog loader defensive paths composite (fo108).
...
* [tests/test_integrator_gate.py](tests/test_integrator_gate.py) (fo21)
...
* ``tests/test_bundle_integrator_gate_direct_contract.py`` (fo107)
