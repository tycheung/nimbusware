...
from console.services import enterprise as enterprise_svc  # noqa: E402
...
def test_fleet_dashboard_enterprise_formatted(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    from env.edition import ENTERPRISE_EDITION, ENV_EDITION
    from iam.constants import API_KEY_HEADER
    from iam.scopes import MAKER_ADMIN_SCOPE
    ...
    monkeypatch.setattr("iam.store.build_iam_store", lambda _url: iam)
