"""``configs/integrator/thresholds.yaml`` loader composite (fo109).
...
[`_emit_bundle_integrator_gate`](packages/hermes_orchestrator/pipeline.py)
(fo107) and
...
* [tests/test_integrator_gate.py:55-66](tests/test_integrator_gate.py) --
  ``load_integrator_gate_emit_enabled`` happy ``true`` / ``false`` (fo21).
