...
| [operator-settings.md](operator-settings.md) | Settings catalog (256 `NIMBUSWARE_*` keys) |
...
| [product/deploy.md](product/deploy.md) | Terraform validate, apply gate, smoke tests, deploy credentials |
