...
| `nimbusware_set_discipline` | `PUT /v1/users/me/discipline-profile` — default collab discipline hat |
| `nimbusware_update_agent_overlay` | `PUT /v1/users/me/agent-overlays/{discipline}` — per-discipline prompt overlay |
